...
public class EclipseHeuristic extends HeuristicClassifier {
	...
	public Classification classifyReport(BugReport report) {
		...
		if(report.getId() == 140669){
			System.out.println("Found 140669");
		}
